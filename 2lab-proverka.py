...
doc = docx.Document('C:\\Users\\RedMazoku\\Downloads\\10.docx')
...
text = "Быт здоровый — труд толковый; быт плохой — и такой."
...
id_char = 0
for i in range(len(doc.paragraphs)): #прогоняем все строкиФ
...
doc.save('C:\\Users\\RedMazoku\\Downloads\\Resultat_2LR_ASCII_STEGANOGRAPHY.docx')
